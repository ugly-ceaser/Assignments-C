...
namespace Constructs
{
    class IQTest
    {
        List<string> aptitude = new List<string>() { "The programmers name is `Martins` ? ", "mMartins is twice the height of  `Divine` ? ", "Nigeria is the highest populated country in Africa ? " };
        List<string> aptitudeAnswers = new List<string>() { "false", "true", "true" };

        List<string> english = new List<string>() { "`Verb` is an action word ? ", "`noun` is a name of a place ? ", "`MANGO` is a noun ?" };
        List<string> englishAnswers = new List<string>() { "true", "false", "true" };

        List<string> maths = new List<string>() { "` The QUOTIENT` of 4 and 2 is 2 ? ", "` The SUM` of 2 and 2 is 4` ? ", "`The Modulus` of  4 into 8 is 0? " };
        List<string> mathsAnswers = new List<string>() { "true", "false", "false" };

        List<string> gk = new List<string>() { "Does Green mean stop in trafic light ? ", "Humans are Omnivores ? ", "Human' are ontop of the food chain ? " };
        ...
        public string checkIQ(double totalScore)
        {
            ...
            {
                result = "You need to finish  the test to see your assessment";
                                    ...
                                    case "1":
                                        {
                                            ...
                                            Console.Clear();
                                            Console.WriteLine("TOTAL SCORE: {0} / 50", Math.Ceiling(IqTest.addBonus(totalScore)));
                                            Console.WriteLine("BONUS ADDED: {0}", IqTest.bonus);
                                            Console.WriteLine("IQ RESULT: {0}", iqResult);
                                            Console.ReadLine();
                                            counter = 0;
                                            break;
                                        }
